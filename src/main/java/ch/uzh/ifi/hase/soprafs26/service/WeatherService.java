...
public class WeatherService {
    ...
    public WeatherService() {
        ...
        this.dailyUrl = "https://api.open-meteo.com/v1/forecast?latitude=47.3769&longitude=8.5417&daily=weather_code&timezone=Europe%2FZurich";
    }
    ...
    public String getDailyWeather() throws Exception{
        HttpClient client = HttpClient.newHttpClient();
        HttpRequest request = HttpRequest.newBuilder()
    ...
    public int parseDailyWeatherData(String json) {
        JSONObject root = new JSONObject(json);
        JSONObject current = root.getJSONObject("daily");
        JSONArray days = current.getJSONArray("weather_code");
        int weatherCode = days.getInt(0);
